...
def is_digit(user_input_number):
    ...
    try:
        user_input_number_copy = int(user_input_number)
        if user_input_number_copy > 0:
            if float(user_input_number) % 1.0  == 0:
                result = True
            else:
                result = False
    except ValueError:
...
def is_between_100_and_999(user_input_number):
    ...
    try:
        user_input_number_copy = int(user_input_number)
        if user_input_number_copy >= 100 and user_input_number_copy <1000:
            result = True
        else:
            result = False
...
def is_duplicated_number(three_digit):
    ...
    three_digit_copy = int(three_digit)
    hundred = three_digit_copy // 100
    ten = (three_digit_copy // 10) % 10
    count = three_digit_copy % 10
    if hundred == ten or hundred == count or ten == count:
        result = True
    else:
        result = False
    # ==================================
...
def get_strikes_or_ball(user_input_number, random_number):
    ...
    # ===Modify codes below=============
    # 조건에 따라 변환되어야 할 결과를 result 변수에 할당
    list_user_input_number = list(user_input_number)
    list_random_number = list(random_number)
    strikes = 0
    ball = 0
    for i in range(0,3):
        if(list_user_input_number == list_random_number):
            strikes = 3
        elif (list_user_input_number[i] in random_number):
            if(list_user_input_number[i] == list_random_number[i]):
                strikes +=1
            else:
                ball +=1
...
def is_yes(one_more_input):
    ...
    if( ('Y' == one_more_input) or ('YES' == one_more_input)):
        result = True
    else:
        result = False
    # ==================================
...
def is_no(one_more_input):
    ...
    # 조건에 따라 변환되어야 할 결과를 result 변수에 할당
    one_more_input = one_more_input.upper()
    if( ('N' == one_more_input) or ('NO' == one_more_input)):
        result = True
    else:
        result = False
    # ==================================
...
def main():
    ...
    while(1):
        ...
        if is_validated_number(user_input) == True:
            valied = get_strikes_or_ball(user_input, random_number)
            print("Strikes : {}, Balls : {}".format(valied[0],valied[1]))
            first_game = True
            if valied[0] == 3:
                while(1):
